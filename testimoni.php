...
<body>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="logo span3">
					...
					<a class="brand" href="index.php"><img src="img/depan.png" alt="Logo"></a>
	...
	<div id="wrapper">
		...
		<div class="container">
			<center>
				<div class="title" style="margin-left: ;">
					<h3>Berikan masukan untuk kami, Agar kami bisa melayani anda lebih baik lagi...</h3>
				</div>
			</center>
			<form id="formku" method="post" action="proses.php" onsubmit="return formCheck(this);">
				<table style="font-style: oblique; font-weight: bold; margin-left: 140px;">
					<tr>
						...
						<td width="30">:</td>
						<td width="550"><input type="text" name="nama" size="30" class="form-control" minlength="3" placeholder="Nama Anda" /></td>
					</tr>
					<tr>
						<td width="150">Email</td>
						<td width="30">:</td>
						<td width="550"><input type="email" name="email" size="30" class="form-control" minlength="3" placeholder="Alamat Email" /></td>
					</tr>
					<tr>
						<td width="150">Komentar</td>
						<td width="30">:</td>
						<td><textarea type="text" name="komentar" size="30" class="form-control" minlength="3" placeholder="Komentar Anda "></textarea></td>
					</tr>
					<tr>
						<td width="150"></td>
						<td width="30"></td>
			...
			<div class="row">
				...
				<div class="card">
					<div class="card-body">
						...
						<?php
						$sql = mysqli_query($koneksi, "SELECT * FROM barang ORDER BY br_id DESC limit 3");
			...
			<div class="komentar">
				...
				while ($isi = fgets($fp, 250)) {
					...
					echo "<tr><td><font color=brown>$pisah[2]</font>, Mengatakan</td></tr>";
