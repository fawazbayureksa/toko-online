...
<body class="bg-gradient-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <a class="btn btn-success btn-xs" href="../registrasi.php"><i class="fas fa-registered"></i> Registrasi</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    $query = mysqli_query($koneksi,"SELECT * FROM user WHERE nama_usr='$name' and pass ='$pass' ");
