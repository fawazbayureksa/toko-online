			...
			<table class="table table-hover table-condensed">
				...
				?>
					<tr>
						...
						<td>
						<a href="hapusbelanja.php?id=<?php echo $data['br_id'] ?>" class="btn btn-danger">Hapus</a>
						</td>
					</tr>
				<?php
				endforeach
				...
				if ($total == 0) {
					...
					echo '
						...
						<a href="checkout.php" class="btn btn-success"><i class="glyphicon glyphicon-shopping-cart icon-white"></i> CHECK OUT &raquo;</a>
						</div></p>
					';
				}
				?>
