...
<body>
								...
								<ul class="nav">
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="./konsumen/index.php?page=dashboard">Konsumen</a></li>
											<!--<li class="divider"></li>
	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				...
				<div class="da-img"><img src="img/parallax-slider/m1.jpg" alt="image01" /></div>
			</div>
			<div class="da-slide">
				<h2>Jacket & Sweater</h2>
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/m2.jpg" alt="image02"></div>
			</div>
			<div class="da-slide">
				<h2>Pants & Jeans</h2>
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/m4.jpg" alt="image03" /></div>
			</div>
			<div class="da-slide">
				<h2>Custom T-Shirt</h2>
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/wolesbaju2.jpg" alt="image04" /></div>
			</div>
			<nav class="da-arrows">
	...
	<div id="wrapper">
		...
		<div class="container">
			...
			<div class="hero-unit">
				<p>
					Toko Baju online terlengkap dan terpercaya,
					dengan harga terjangkau, kurang dari 100rb anda sudah dapat
					memiliki produk kami. Selamat Berbelanja..
				</p>
						...
						?>
							<div class="span4">
								<div class="icons-box">
									...
									<img src="./gambar/<?php echo $data['br_gbr']; ?>" />
									<div>
				...
				<div class="icons-box-vert-container">
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p style="font-size: 14px">Dapatkan kemudahan berbelanja di Aimhi Shop, 
								Kami menyediakan kebutuhan untuk fashion anda.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p style="font-size: 14px">Dapatkan kemudahan pengiriman barang ke rumah anda dengan
								 minimal belanja 300 ribu radius 10km dari kantor kami.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p style="font-size: 14px">Anda bisa memesan produk kami melalui gadget kesayangan anda, 
								belanja di Aimhi Shop praktis dan mudah.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								<h3>Sosial Media</h3>
								<p style="font-size: 14px">Follow twitter dan halaman facebook kami untuk mendapatkan 
								update promo spesial setiap harinya.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
			...
			<div class="row">
				...
				<div class="span3">
					...
					<p style="font-size: 14px">
						Aimhi Shop adalah toko online yang bergerak di bidang fashion, 
						sasaran kami semua kalangan baik muda maupun tua, mulai dari anak - anak dan orang dewasa.
					</p>
				...
				<div class="span3">
					...
					<h3>Alamat Kami</h3>
				 <p style="font-size: 14px">Jl. M. Ali dg. Gassing No.112, Kec. Binamu, Kab. Jeneponto, Kode Pos 92311<br />
